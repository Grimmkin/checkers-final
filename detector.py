...
def get_chessboard_intersections(img, debug = False):
    ...
    try:
        ...
        gray_filtered = cv2.bilateralFilter(gray, params.bilateral_filter_size, 75, 75)
...
def __cluster_eliminate_duplicate(lines, cluster, intersect_line, img_shape):
    ...
    dbscan_test = DBSCAN(eps = params.dbscan_eps_duplicate_elimination, min_samples = 1).fit(intersection_points)
